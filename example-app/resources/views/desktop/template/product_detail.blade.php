    ...
    <div class="p-6 flex flex-col md:flex-row  rounded-lg mt-10 gap-10">
        ...
        <!-- Hình ảnh chính -->
            <div class="relative mb-6">
                <img id="main-image" class="w-full rounded-lg " src="../img/chen1.png" alt="Hình ảnh sản phẩm chính">
                <!-- Nút điều hướng trái -->
                <button class="absolute top-1/2 left-0 p-2 bg-gray-200 rounded-full -translate-y-1/2 hover:bg-gray-300">
                &lt;
                </button>
                <!-- Nút điều hướng phải -->
                <button class="absolute top-1/2 right-0 p-2 bg-gray-200 rounded-full -translate-y-1/2 hover:bg-gray-300">
                &gt;
                </button>
            </div>
        ...
        <div class="md:w-1/2 p-6">
            <h1 class="text-2xl font-bold mb-2">LY'S</h1>
            <p class="text-gray-600 text-lg mb-2">Chén cơm 11.2 cm - Jasmine Ly's - Trắng Ngà</p>
            ...
            <div class="flex items-center space-x-4 mb-4">
                <span class="text-2xl font-bold text-cmain">880.000đ</span>
                <span class="text-gray-500 line-through">1.880.000đ</span>
            </div>

            <!-- Tùy chọn màu sắc -->
            <div class="mb-4">
            <span class="block text-sm font-semibold text-gray-700 mb-2">Màu sắc</span>
            <div id="color-options" class="flex space-x-2">
                <button class="px-3 py-2 border rounded bg-gray-50 text-gray-600" onclick="selectColor(this)">Trắng ngà</button>
                <button class="px-3 py-2 border rounded bg-gray-50 text-gray-600" onclick="selectColor(this)">Không họa tiết</button>
                <button class="px-3 py-2 border rounded bg-gray-50 text-gray-600" onclick="selectColor(this)">Xanh lam</button>
            </div>
        </div>
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center space-x-2">
                ...
                <input id="quantity" type="text" value="1" class="w-12 text-center border rounded px-2 py-2" readonly>
...
<div class="container-main mt-5 px-[5%] lg:px-0">
    ...
    <div class="mt-4">
        ...
        <div class="tab-content" id="guide" style="display: none;">
            ...
            <p class="text-gray-600 mt-2">
                - Sử dụng kem chống nắng sau khi bôi kem vào ban ngày để bảo vệ da khỏi tác động của ánh nắng mặt trời.
            </p>
        </div>
...
<div class="container-main px-[5%] lg:px-0">
    <div class="bg-gray-50 p-6">
        ...
        <div class="flex justify-center items-center space-x-6 bg-white shadow-md rounded-t-md p-6">
            <button class="text-lg font-semibold text-blue-700 border-b-4 border-blue-700 pb-2">Đánh giá từ khách hàng</button>
        ...
        <div class="bg-white shadow-md rounded-md p-6 mt-4">
            ...
            <div class="flex items-start space-x-4">
                ...
                <div class="flex-grow">
                    ...
                    <p class="mt-2 text-gray-700">Bức tranh tuyệt đẹp mùa Trung Thu bắt đầu từ sự an nhiên trong tâm hồn.</p>
